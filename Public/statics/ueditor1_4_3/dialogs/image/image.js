                    ...
                    if (browser.ie && browser.version <= 7) {
                        ...
                        uploader.makeThumb(file, function (error, src) {
                            if (error || !src) {
                                ...
                                var $img = $('<img src="' + src + '">');
                                var $input = $('<input type="text" style="display:block!important;width: 98%!important;margin-top: 4px;border: 1px solid red!important;">');                                    //新家的===========================================================
        ...
        setList: function (list) {
            ...
            if(list.length) {
                for (i = 0; i < list.length; i++) {
                    ...
                    // input.setAttribute('value', list[i].src);
